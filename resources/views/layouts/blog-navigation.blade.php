<header class="bg-white px-6 shadow dark:bg-slate-900">
    ...
    >
        ...
        <div class="flex">
            ...
            <x-dropdown align="right" width="48">
                @auth
                @include('layouts._dropdown-authProfile')
                @endauth
                @guest
                        <x-slot name="trigger">
    ...
    >
        ...
        <a
            href="{{route('about')}}"
            class="block rounded-md px-3 py-2 {{request()->routeIs('about')?'bg-sky-500':'text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white'}}"
        >
            About
        </a>
        <a
            href="{{route('posts.index')}}"
            class="block rounded-md px-3 py-2 {{request()->routeIs('posts.*')?'bg-sky-500':'text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white'}}"
        >
            Blog
        </a>
        <a
            href="{{route('contact')}}"
            class="block rounded-md px-3 py-2 {{request()->routeIs('contact')?'bg-sky-500':'text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white'}}"
        >
            Contact
        </a>
    </div>
